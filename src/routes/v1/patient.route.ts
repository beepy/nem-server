...
import { patientController, patientValidation } from '../../modules/patient';
...
router
  ...
  .get(auth('managePatients'), validate(patientValidation.getPatients), patientController.getPatients);

router
  .route('/:patientId')
  .get(auth('managePatients'), validate(patientValidation.getPatient), patientController.getPatient)
